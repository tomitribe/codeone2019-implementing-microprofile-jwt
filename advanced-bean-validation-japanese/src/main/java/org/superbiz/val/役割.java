...
public @interface 役割 {
    ...
    class Constraint implements ConstraintValidator<org.superbiz.val.役割, JsonWebToken> {
        private org.superbiz.val.役割 役割;

        @Override
        public void initialize(final org.superbiz.val.役割 constraint) {
            this.役割 = constraint;
        }
